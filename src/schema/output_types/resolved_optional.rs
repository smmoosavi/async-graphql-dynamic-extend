...
impl Foo {
    async fn resolve_bar(&self) -> Option<Bar> {
        if self.empty {
            None
        } else {
            Some(Bar {
    ...
    async fn resolve_the_string(&self) -> Option<String> {
        if self.empty {
            None
        } else {
            Some("the string".to_string())
        }
    }

    async fn resolve_the_i32(&self) -> Option<i32> {
        if self.empty {
            None
        } else {
            Some(42)
    ...
    async fn resolve_the_f32(&self) -> Option<f32> {
        if self.empty {
            None
        } else {
            Some(42.0)
    ...
    async fn resolve_the_bool(&self) -> Option<bool> {
        if self.empty {
            None
        } else {
            Some(true)
    ...
    async fn resolve_the_id(&self) -> Option<ID> {
        if self.empty {
            None
        } else {
            Some(ID("the id".to_string()))
        }
    }
}
